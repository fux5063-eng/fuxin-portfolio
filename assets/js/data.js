      ...
      },
      {
        ...
        sections: [
          ...
          },
          {
            ...
            items: [],
            tabs: [
              { t: 'AIGC Skill Hub', f: 'assets/img/ai/toolset-p27.jpg', d: '当前注册表收录 34 项 Skill，统一处理发现、分类、调用与跨端同步；总入口负责找，管理页负责改；同步原则是补齐缺失项，不静默覆盖同名 Skill。' },
              { t: 'Codex Camera', f: 'assets/img/ai/toolset-p29.jpg', d: '把唤起、镜像预览、拍照保存与复制剪贴板压缩为一次操作，让现实画面直接进入输入流。' },
              { t: '模式切换器', f: 'assets/img/ai/toolset-p32.jpg', d: '把不同线路放进同一决策界面；切换做成一次可回滚事务，先识别当前线路再选择目标方案，高风险动作前弹窗交代影响范围与同步范围。' },
              { t: 'Codex Meter', f: 'assets/img/ai/toolset-p37.jpg', d: '桌面常驻胶囊显示各账户当前可用状态与近期用量，点击展开明细；设置页把常驻行为、同步来源与视觉参数拆开。' }
            ]
          },
          {
            h: '做出什么', en: 'WHAT',
