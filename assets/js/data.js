...
/* ===== 图片占位：平均色 + 原始宽高（加载前显示底色、并预留位置避免跳动） ===== */
const IMGC = {
  'assets/img/about/portrait.webp': '#9a8f8e',
  'assets/img/ai/designdna-p18.webp': '#f1f2f1',
  'assets/img/ai/designdna-p19.webp': '#e7e2dd',
  'assets/img/ai/designdna-p20.webp': '#e1d8d7',
  'assets/img/ai/designdna-p22.webp': '#e2dfdd',
  'assets/img/ai/designdna-p25.webp': '#e6e7e7',
  'assets/img/ai/internship-p39.webp': '#f6f7f9',
  'assets/img/ai/proto-breakout.webp': '#0c1221',
  'assets/img/ai/proto-fruit.webp': '#14182f',
  'assets/img/ai/proto-tetris.webp': '#141929',
  'assets/img/ai/robot-p06.webp': '#cdcaca',
  'assets/img/ai/robot-p08.webp': '#e2e3e3',
  'assets/img/ai/robot-p09.webp': '#eaebeb',
  'assets/img/ai/robot-p13.webp': '#eaebec',
  'assets/img/ai/robot-p15.webp': '#fbfbfa',
  'assets/img/ai/toolset-p27.webp': '#f6f6f6',
  'assets/img/ai/toolset-p29.webp': '#d8dad6',
  'assets/img/ai/toolset-p32.webp': '#c2c5c6',
  'assets/img/ai/toolset-p33.webp': '#97999f',
  'assets/img/ai/toolset-p37.webp': '#b6b9bb',
  'assets/img/case/id/doggie-d1.webp': '#d0d1b9',
  'assets/img/case/id/doggie-d2.webp': '#cecfbb',
  'assets/img/case/id/doggie-d3.webp': '#b6b7a5',
  'assets/img/case/id/doggie-d4.webp': '#bcbeab',
  'assets/img/case/id/doggie-explode.webp': '#c7c6bb',
  'assets/img/case/id/doggie-hero-16x10.webp': '#d6d3cc',
  'assets/img/case/id/doggie-pack.webp': '#aeaca6',
  'assets/img/case/id/doggie-ref-1.jpg': '#917860',
  'assets/img/case/id/doggie-ref-1.webp': '#917860',
  'assets/img/case/id/doggie-ref-2.jpg': '#b0a99b',
  'assets/img/case/id/doggie-ref-2.webp': '#b0aa9b',
  'assets/img/case/id/doggie-ref-3.jpg': '#a39389',
  'assets/img/case/id/doggie-ref-3.webp': '#a39389',
  'assets/img/case/id/doggie-ref-4.jpg': '#949397',
  'assets/img/case/id/doggie-ref-4.webp': '#959397',
  'assets/img/case/id/doggie-scene.webp': '#977d67',
  'assets/img/case/id/doggie-sketch.webp': '#d7d5d3',
  'assets/img/case/id/doggie-story.webp': '#dfdede',
  'assets/img/case/id/doggie-threeview.webp': '#e0dfd9',
  'assets/img/case/id/lumora-hero.webp': '#8d5c3e',
  'assets/img/case/id/lumora-p2.webp': '#dcd6d1',
  'assets/img/case/id/lumora-p3.webp': '#f4f4f4',
  'assets/img/case/id/lumora-p4.webp': '#ededed',
  'assets/img/cover/aid.webp': '#dedee0',
  'assets/img/cover/designdna-ui.webp': '#ebedee',
  'assets/img/cover/exercises.webp': '#e9e8ed',
  'assets/img/cover/internship.webp': '#f4f5f7',
  'assets/img/cover/lumora.webp': '#ae8f7d',
  'assets/img/cover/navlight.webp': '#dbdbdb',
  'assets/img/cover/proto.webp': '#535668',
  'assets/img/cover/robot.webp': '#e6e7e7',
  'assets/img/cover/smartlock.webp': '#7c7377',
  'assets/img/cover/toolset.webp': '#f4f5f5',
  'assets/img/cover/visual.webp': '#c09a97',
  'assets/img/cover/wateralarm.webp': '#dfdcdc',
  'assets/img/id/aid-p45.webp': '#d7d7d8',
  'assets/img/id/aid-p46.webp': '#e6e4e2',
  'assets/img/id/aid-p47.webp': '#e4e2e0',
  'assets/img/id/exercises-p50.webp': '#e9e8e9',
  'assets/img/id/navlight-p04.webp': '#d6d5d4',
  'assets/img/id/navlight-p05.webp': '#e3e2e1',
  'assets/img/id/navlight-p06.webp': '#cdcece',
  'assets/img/id/navlight-p09.webp': '#b7b7b7',
  'assets/img/id/smartlock-p41.webp': '#1e262d',
  'assets/img/id/smartlock-p43.webp': '#4d4044',
  'assets/img/id/smartlock-p44.webp': '#54565c',
  'assets/img/id/visual-p48.webp': '#b07b76',
  'assets/img/id/visual-p49.webp': '#ecedef',
  'assets/img/id/wateralarm-p37.webp': '#dbd6d6',
  'assets/img/id/wateralarm-p38.webp': '#e8e8e7',
  'assets/img/id/wateralarm-p40.webp': '#e7e6e5',
  'assets/img/qr/dl-ai.png': '#9d9fa1',
  'assets/img/qr/dl-id.png': '#9a9c9e',
  'assets/img/qr/site-1024.png': '#9d9d9e',
  'assets/img/qr/site-512.png': '#9d9d9e',
  'assets/img/qr/wechat.jpg': '#eddae5',
  'assets/img/qr/wechat.png': '#e2e2e2'
};
const IMD = {
  'assets/img/about/portrait.webp': [1086, 1448],
  'assets/img/ai/designdna-p18.webp': [1500, 844],
  'assets/img/ai/designdna-p19.webp': [1500, 844],
  'assets/img/ai/designdna-p20.webp': [1500, 844],
  'assets/img/ai/designdna-p22.webp': [1500, 844],
  'assets/img/ai/designdna-p25.webp': [1500, 844],
  'assets/img/ai/internship-p39.webp': [1500, 844],
  'assets/img/ai/proto-breakout.webp': [1500, 844],
  'assets/img/ai/proto-fruit.webp': [1500, 844],
  'assets/img/ai/proto-tetris.webp': [1500, 844],
  'assets/img/ai/robot-p06.webp': [1500, 844],
  'assets/img/ai/robot-p08.webp': [1500, 844],
  'assets/img/ai/robot-p09.webp': [1500, 844],
  'assets/img/ai/robot-p13.webp': [1500, 844],
  'assets/img/ai/robot-p15.webp': [1500, 844],
  'assets/img/ai/toolset-p27.webp': [1500, 844],
  'assets/img/ai/toolset-p29.webp': [1500, 844],
  'assets/img/ai/toolset-p32.webp': [1500, 844],
  'assets/img/ai/toolset-p33.webp': [1500, 844],
  'assets/img/ai/toolset-p37.webp': [1500, 844],
  'assets/img/case/id/doggie-d1.webp': [1184, 792],
  'assets/img/case/id/doggie-d2.webp': [1184, 792],
  'assets/img/case/id/doggie-d3.webp': [1184, 792],
  'assets/img/case/id/doggie-d4.webp': [1184, 792],
  'assets/img/case/id/doggie-explode.webp': [1600, 900],
  'assets/img/case/id/doggie-hero-16x10.webp': [1600, 1000],
  'assets/img/case/id/doggie-pack.webp': [1504, 792],
  'assets/img/case/id/doggie-ref-1.jpg': [423, 371],
  'assets/img/case/id/doggie-ref-1.webp': [423, 371],
  'assets/img/case/id/doggie-ref-2.jpg': [423, 371],
  'assets/img/case/id/doggie-ref-2.webp': [423, 371],
  'assets/img/case/id/doggie-ref-3.jpg': [421, 370],
  'assets/img/case/id/doggie-ref-3.webp': [421, 370],
  'assets/img/case/id/doggie-ref-4.jpg': [403, 354],
  'assets/img/case/id/doggie-ref-4.webp': [403, 354],
  'assets/img/case/id/doggie-scene.webp': [832, 828],
  'assets/img/case/id/doggie-sketch.webp': [1600, 900],
  'assets/img/case/id/doggie-story.webp': [1600, 900],
  'assets/img/case/id/doggie-threeview.webp': [1600, 900],
  'assets/img/case/id/lumora-hero.webp': [1160, 1005],
  'assets/img/case/id/lumora-p2.webp': [1600, 900],
  'assets/img/case/id/lumora-p3.webp': [1600, 900],
  'assets/img/case/id/lumora-p4.webp': [1600, 900],
  'assets/img/cover/aid.webp': [1600, 1000],
  'assets/img/cover/designdna-ui.webp': [1600, 1000],
  'assets/img/cover/exercises.webp': [1600, 1000],
  'assets/img/cover/internship.webp': [1600, 1000],
  'assets/img/cover/lumora.webp': [1600, 1000],
  'assets/img/cover/navlight.webp': [1600, 1000],
  'assets/img/cover/proto.webp': [1600, 1000],
  'assets/img/cover/robot.webp': [1600, 1000],
  'assets/img/cover/smartlock.webp': [1600, 1000],
  'assets/img/cover/toolset.webp': [1600, 1000],
  'assets/img/cover/visual.webp': [1600, 1000],
  'assets/img/cover/wateralarm.webp': [1600, 1000],
  'assets/img/id/aid-p45.webp': [1500, 844],
  'assets/img/id/aid-p46.webp': [1500, 844],
  'assets/img/id/aid-p47.webp': [1500, 844],
  'assets/img/id/exercises-p50.webp': [1500, 844],
  'assets/img/id/navlight-p04.webp': [1500, 844],
  'assets/img/id/navlight-p05.webp': [1500, 844],
  'assets/img/id/navlight-p06.webp': [1500, 844],
  'assets/img/id/navlight-p09.webp': [1500, 844],
  'assets/img/id/smartlock-p41.webp': [1500, 844],
  'assets/img/id/smartlock-p43.webp': [1500, 844],
  'assets/img/id/smartlock-p44.webp': [1500, 844],
  'assets/img/id/visual-p48.webp': [1500, 844],
  'assets/img/id/visual-p49.webp': [1500, 844],
  'assets/img/id/wateralarm-p37.webp': [1500, 844],
  'assets/img/id/wateralarm-p38.webp': [1500, 844],
  'assets/img/id/wateralarm-p40.webp': [1500, 844],
  'assets/img/qr/dl-ai.png': [512, 512],
  'assets/img/qr/dl-id.png': [512, 512],
  'assets/img/qr/site-1024.png': [1024, 1024],
  'assets/img/qr/site-512.png': [512, 512],
  'assets/img/qr/wechat.jpg': [720, 720],
  'assets/img/qr/wechat.png': [720, 720]
};
const IMGV = {
  ...
  'assets/img/case/id/doggie-ref-1.webp': [423, 0, 0, 0],
  'assets/img/case/id/doggie-ref-2.webp': [423, 0, 0, 0],
  'assets/img/case/id/doggie-ref-3.webp': [421, 0, 0, 0],
  'assets/img/case/id/doggie-ref-4.webp': [403, 0, 0, 0],
  'assets/img/case/id/doggie-scene.webp': [832, 0, 0, 760]
};
